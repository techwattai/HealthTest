from Endpoints import body_vitals, ai_appointments, ai_diagnosis, ai_summarization, ai_icd10, ai_drug_interaction, ai_guest_booking, ai_health_analysis, ai_vitals_anomaly, ai_adherence, ai_lab_interpretation, ai_readmission, ai_prescription, ai_no_show, ai_imaging, ai_clinical_doc, email_service
...
app.include_router(ai_clinical_doc.router)
